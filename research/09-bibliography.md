...
Local copies live in [`../sources/`](../sources/) when the file could be fetched cleanly.

## 1988–1991 primary

- Reynolds, J. *The Helminthiasis of the Internet.* RFC 1135. December 1989. Local: `sources/rfc1135.txt`. <https://www.rfc-editor.org/rfc/rfc1135.txt>
- Cornell University, Commission of Preliminary Enquiry. *The Computer Worm.* Report to the Provost. 6 February 1989. Local: `sources/cornell-worm-report.pdf`. 145 pages.
- Eisenberg, T., Gries, D., Hartmanis, J., Holcomb, D., Lynn, M. S., Santoro, T. "The Cornell Commission: On Morris and the Worm." *Communications of the ACM* 32(6), June 1989. Local: `sources/eisenberg-cacm-cornell.pdf`.
...
- "Morris worm." Wikipedia, accessed 20 September 2026. Use as a map; check against Cornell / RFC 1135 / FBI.
- Graham, Paul. "The Submarine." Footnote on the 6,000/60,000 statistic. <http://www.paulgraham.com/submarine.html>
- Stoll, Clifford. *The Cuckoo's Egg.* 1989, epilogue.
- Moore, D. et al. "Inside the Slammer Worm." *IEEE Security & Privacy,* 2003.
- CrowdStrike / Microsoft / congressional record on the 19 July 2024 sensor update. NYT 19 July 2024; House Homeland Security subcommittee hearing; Parametric loss estimate as reported in that record.

## Mythos / Glasswing (2026)

- Anthropic. "Project Glasswing." 7 April 2026. <https://www.anthropic.com/project/glasswing>
- Carlini, N. et al. "Assessing Claude Mythos Preview's cybersecurity capabilities." 7 April 2026. <https://www.anthropic.com/research/mythos-preview>
- Anthropic. "Project Glasswing: An initial update." 22 May 2026. <https://www.anthropic.com/research/glasswing-initial-update>
- Anthropic. "Expanding Project Glasswing." 2 June 2026. <https://www.anthropic.com/news/expanding-project-glasswing>
...
- UK AISI. Evaluation of Claude Mythos Preview's cyber capabilities (linked from the above).
- Anthropic. "Improving our alignment and security practices." 31 August 2026. (Incidents in evaluation environments.)
...
- Viral screenshots of model "confessions" without the underlying incident report.
- Exploit writeups beyond the level of *class of bug* (buffer overflow, debug command, trusted-host). This archive is not a reproduction guide.
